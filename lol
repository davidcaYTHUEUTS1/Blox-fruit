...
AutoFarmLever(function ()CheckQuest() 
...
local Window = OrionLib:MakeWindow({Name = "Edward Newgate Hub", HidePremium = false, IntroText = "Edward Newgate", IntroEnabled = true, SaveConfig = true, ConfigFolder = "OrionTest"})


OrionLib:MakeNotification({
	Name = "Welcome to Edward Newgate Hub",
...
Main:AddLabel("Credit by Newgate")
Main:AddLabel("Script make Edward Newgate Hub")
Main:AddLabel("very thank for use script ")
